  ...
  return (
    <View style={consist.card}>
      <View style={consist.header}>
        ...
        <Text style={consist.pct}>{pct}% COMPLETED</Text>
      </View>
      ...
      <View style={consist.legendRow}>
        <View style={consist.legendItem}>
          ...
          <Text style={consist.legendText}>Routine Done</Text>
        </View>
        <View style={consist.legendItem}>
...
function NoScanBanner() {
  return (
    <View style={styles.noScanBanner}>
      ...
      <Text style={styles.noScanText}>No scan this week — take a scan to see your zone analysis.</Text>
    </View>
  );
}
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {report?.focus && (
            <View style={styles.focusCard}>
              ...
              <Text style={styles.focusTitle}>{report.focus.title}</Text>
              <Text style={styles.focusDesc}>{report.focus.desc}</Text>
            </View>
          )}
